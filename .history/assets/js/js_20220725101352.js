...
let headerModalOut = document.getElementsByClassName("btn-ticket-out");
let footerModalOut = document.getElementsByClassName("ticket-footer-close");
// SLIDER
...
// headerModalOut.addEventListener("click", outMoDal());
// footerModalOut.addEventListener("click", outMoDal());
